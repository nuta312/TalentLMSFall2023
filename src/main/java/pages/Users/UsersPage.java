...
public class UsersPage extends BasePage {
    User randomUser = FakeDataHelper.createNewUserWithFakerData();//создает новую переменную randomUser типа User,
    // которая будет содержать сгенерированные фейковые данные.
    ...
    public UsersPage fillUpUserWithFakerData(){ //  метод  который заполняет с фейковыми данными
        webElementHelper
