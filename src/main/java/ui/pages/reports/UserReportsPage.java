...
import ui.pages.TalentLMS_PAGES;
...
public class UserReportsPage extends BasePage {
    ...
    public UserReportsPage goToTheCustomReportsPage() {
        browserManager.openByNavigate(TalentLMS_PAGES.MY_DOMAIN.getURL() + TalentLMS_PAGES.TALENTLMS.getURL() + TalentLMS_PAGES.USER_REPORTS.getURL());
        return this;
    }
